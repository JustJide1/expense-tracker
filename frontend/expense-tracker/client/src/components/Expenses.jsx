...
export default function Expenses() {
    ...
    const fetchExpenseTransactions = async () => {
        try {
            ...
            setAllTransactions(expenseOnly);
    ...
    const handleFilter = (filters) => {
        // Pre-compute once — avoids N repeated Date constructions and toLowerCase calls
            ...
            <div style={styles.formCard}>
                ...
                <form onSubmit={handleSubmit} style={styles.form}>
                    ...
                    <input
                        style={styles.input}
                        type="text"
                        placeholder="Description (e.g. Uber to work)"
...
const styles = {
    ...
    itemEditing: { borderColor: "#6366f1", background: "rgba(99,102,241,0.08)" },
    itemLeft: { flex: 1 },
    ...
    itemAmount: { fontSize: 15, fontWeight: 700, color: "#f43f5e" },
